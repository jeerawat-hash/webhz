  ...
  <div class="card border-0 shadow my-5">
    ...
    <div class="row">
        ...
        <div class="col-4 mb-3"> 
                <div class="card ">
                    <img class="card-img-top" width="286" height="180" src="https://ranonline.playpark.com/th-th/wp-content/uploads/2020/02/ran-share.jpg" alt="Card image cap">
                    <div class="card-body">
                    <h5 class="card-title">ไอเทม</h5>
                    <p class="card-text">รายละเอียดไอเทม</p>
                    </div> 
                    <div class="card-footer">
                    <small class="text-muted">สิ้นสุดการขายใน.....</small>
                    </div>
                </div> 
        </div>
