    ...
    <div class="row">
      ...
      <div class="col-3 mx-auto">
          <div class="text-center">
              1 - 160 หน้า โรงเรียนจนถึง วินาศ <br>
              160 ขึ้นไป วินาศถึง Ep3 และ ศูนย์วิจัย
          </div>
      </div>
...
<div class="card border-0 shadow my-5">
    ...
    <div class="col-3 mx-auto">
          <div class="text-center">
             บอสทุกตัวเกิดทุก 4 ชม รายละเอียดเพิ่มเติมภายหลัง
          </div>
      </div>
...
<div class="card border-0 shadow my-5">
    ...
    <div class="col-3 mx-auto">
          <div class="text-center">
              บัตรสวัสดิการแห่งรัฐ ผสมได้รับ ไอเทมบัตรปรับเรท
          </div>
      </div>
...
<div class="card border-0 shadow my-5">
   ...
   <br>
    ...
    <div class="col-3 mx-auto">
          <div class="text-center">
              เช็คชื่อทุกวันได้รับ ไอเทม จำนวน 3 ชิ้นต่อวัน รายละเอียดจะอัพเดทอีกครั้ง
          </div>
      </div>
