        ...
        <div class="container">
            <div class="row">
                <div class="col-8">
                    ...
                    <div class="container">
                        <h2 class="display-10" style="-webkit-text-stroke: 2px black;">Hazakura RanOnline EP7 Classic ยินดีต้อนรับ</h2>
                        <p class="lead" style="-webkit-text-stroke: 2px black;">เซิฟเวอร์เปิดให้บริการแนวเก็บเลเวลหาของในเวอร์ชั่นคลาสสิคไม่เวอร์ พร้อมมีกิจกรรมต่างๆรองรับผู้เล่นได้หลากหลายแบบด้วย 2 Channel NonPK และ FreePK.</p>
                    </div>
                    </div>
                </div>
                <div class="col-4">
