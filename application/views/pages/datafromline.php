					...
					ChaNum : ChaID
						...
						for (var i = 0; i < Obj.tab1.ItemID.length; i++) { 
							...
							tablehtml += "<tr>"+
									      ...
									      "<td><button class='btn btn-success isSale' itemqty='"+ItemQTY+"' enhance='"+enhance+"' ItemID='"+Obj.tab1.ItemID[i]+"' itemInfo='"+Obj.tab1.MEM[i]+"'>ฝากขาย</button> <div class='spinner'></div> </td>"+
									    "</tr> "; 
						}
